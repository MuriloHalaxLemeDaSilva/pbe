...
sair
                    <a href="../sair.php" class="btn btn-secondary"></a>
                </nav>
            </div>
        </div>
    </header>
        ...
        <div class="notes-grid">
            <?php if (empty($notes)): ?>
                <div class="empty-state">
                    ...
                    <p><?php echo empty($search) ? 'Crie sua primeira nota para começar!' : 'Try adjusting your search criteria'; ?></p>
                    <?php if (empty($search)): ?>
                        <a href="criar.php" class="btn btn-primary">Criar notas</a>
                    <?php endif; ?>
                </div>
            <?php else: ?>
                    ...
                    <div class="note-card" style="background-color: <?php echo $note['color']; ?>">
                        ...
                        <div class="note-header">
                            ...
                            <div class="note-actions">
                                <a href="view.php?id=<?php echo $note['id']; ?>" class="btn-icon" title="View">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="edit.php?id=<?php echo $note['id']; ?>" class="btn-icon" title="Edit">
                        ...
                        <div class="note-footer">
                            <small>Atualizado: <?php echo date('M j, Y g:i A', strtotime($note['updated_at'])); ?></small>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
