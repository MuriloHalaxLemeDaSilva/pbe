        ...
        <div class="container">
            <div class="header-content">
                ...
                <nav class="nav-links">
                    ...
                    <a href="index.php" class="btn btn-secondary">Voltar às notas</a>
    ...
    <div class="container">
        <article class="note-view" style="background-color: <?php echo $note['color']; ?>">
            <?php if ($note['is_pinned']): ?>
                <div class="note-pinned"><i class="fas fa-thumbtack"></i> Fixado</div>
            <?php endif; ?>
            ...
            <header class="note-view-header">
                ...
                <div class="note-meta">
                    ...
                    <span class="note-date">
                        Criado: <?php echo date('M j, Y g:i A', strtotime($note['created_at'])); ?>
                        <?php if ($note['created_at'] != $note['updated_at']): ?>
                            <br>Atualizar: <?php echo date('M j, Y g:i A', strtotime($note['updated_at'])); ?>
                        <?php endif; ?>
                    </span>
                </div>
            </header>
            ...
            <div class="note-view-actions">
                ...
                <a href="index.php" class="btn btn-secondary">De volta às notas</a>
            </div>
        </article>
    </div>
